...
router
    .route('/')
    .post(authController_1.default.protect, challengeController_1.default.addChallenge)
    .get(challengeController_1.default.getAllChallenges);
router
    .route('/:id')
    .get(challengeController_1.default.getChallenge)
    .patch(authController_1.default.protect, challengeController_1.default.updateChallenge)
